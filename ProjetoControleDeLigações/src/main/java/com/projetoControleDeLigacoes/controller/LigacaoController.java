...
import com.projetoControleDeLigacoes.services.LigacaoService;
...
public class LigacaoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Ligacao> buscaProdutoControlId (@PathVariable Long id){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Ligacao> alteraProdutoControl(@PathVariable Long id, @RequestBody Ligacao ligacao){
    	Ligacao alteraLigacao = ligacaoService.alterarProduto(id, ligacao);
